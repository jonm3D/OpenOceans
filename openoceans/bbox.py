...
class Bbox:
    ...
    def edit(self):
        ...
        if is_nb == False:
            warnings.warn('Interactively editing bounding box only available in notebook/qtconsole environments.')
            return None
        ...
        m = Map(basemap=basemaps.Esri.WorldImagery, center=plot_center, zoom=7, scroll_wheel_zoom=True)
        dc = DrawControl(circlemarker={}, rectangle={}, polyline={}, polygon={}, edit=True, remove=False) 
    ...
    def from_drawing(cls):
        ...
        if is_nb == False:
            warnings.warn('Interactively drawn bounding box only available in notebook/qtconsole environments.')
            return None
        ...
        m = Map(basemap=basemaps.Esri.WorldImagery, center=(23.951465, -78.121304), zoom=4, scroll_wheel_zoom=True)
